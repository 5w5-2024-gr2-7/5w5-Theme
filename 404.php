...
<main class="page-404">
    <div class="container">
        <div class="titre-404">
        <h1 class="error-title">Désolé, cette page n'existe pas<i class="fa-solid fa-face-frown"></i></h1>
        </div>
        ...
        <img class="error-img" src="<?php echo get_site_url(); ?>/wp-content/uploads/2024/12/image.png" alt="À propos">
